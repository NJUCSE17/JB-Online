...
@section ('title', __('labels.backend.forum.courses.management') . ' | ' . __('labels.backend.forum.courses.edit'))
...
@section('content')
    {{ html()->modelForm($course, 'PATCH' , route('admin.forum.course.update', $course->id))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('labels.backend.forum.courses.edit') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->select('difficulty', [
                                    ...
                                    3=>__('validation.attributes.backend.forum.courses.difficulty_label.3')])
                                ->class('form-control')
                                ->attribute('maxlength', 191)
                                ->required() }}
                        </div><!--col-->
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {{ html()->select('restrict_level', [
                                    ...
                                    2=>__('validation.attributes.backend.forum.courses.restrict_level_label.2')])
                                ->class('form-control')
                                ->attribute('maxlength', 191)
                                ->required() }}
                        </div><!--col-->
