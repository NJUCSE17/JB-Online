...
@section ('title', app_name() . ' | ' . __('labels.backend.forum.notices.management'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    {{ __('labels.backend.forum.notices.management') }} <small class="text-muted">{{ __('labels.backend.forum.notices.active') }}</small>
                </h4>
            </div><!--col-->

            <div class="col-sm-7">
                @include('backend.forum.notice.includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
