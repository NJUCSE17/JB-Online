...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Laravel '.app()->version().' JB Online'),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Application Cover Art
    |--------------------------------------------------------------------------
    |
    | This value is source for the cover art of the head page of your application.
    |
    */

    'coverart' => env('APP_COVERART', "#"),

    /*
    |--------------------------------------------------------------------------
    | Application Blog on Homepage
    |--------------------------------------------------------------------------
    |
    | This value is option and source of home page blog.
    |
    */
