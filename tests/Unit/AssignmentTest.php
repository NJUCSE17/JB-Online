...
class AssignmentTest extends TestCase
{
    ...
    public function testAssignmentFunctions()
    {
        ...
        for ($i = 0; $i < 2; ++$i) {
            ...
            $assignments[$i]['content_html'] = $this->parser->text(
        ...
        if (true) {
            $response = $this->get(
                '/api/assignment?assignment_id='.$assignments[0]['id']
            );
            $response->assertStatus(200);
            $response->assertExactJson(
                [
        ...
        $assignments[0]['content_html'] = $this->parser->text(
            $assignments[0]['content']
        );
        $assignments[0]['due_time'] = $this->faker->dateTimeInInterval(
            'now',
            '+5 days'
        )->format('Y-m-d H:i:s');
