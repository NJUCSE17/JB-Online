...
Breadcrumbs::for('frontend.forum.course', function ($trail) {
    $trail->parent('frontend.index');
    $trail->push(__('strings.frontend.breadcrumb.course'), route('frontend.forum.course'));
});

Breadcrumbs::for('frontend.forum.course.view', function ($trail, $course) {
    $trail->parent('frontend.forum.course');
